...
| `movementDuration`		| Integer	| null			| optional, duration of a full shutter movement from 'open' to 'close' in seconds. If set, will be used to approximate shutter intermediate position |
